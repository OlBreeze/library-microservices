...
# SECRET_KEY = 'django-insecure-v20p!l28zesqcu%a&#xla&g+8y%=0ie$w1y1l8%a3lq=893!z6'
...
# JWT settings Books Service НЕ генерує токени
SIMPLE_JWT = {
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'books_service.custom_auth.StatelessJWTAuthentication',
    ),
    'DEFAULT_PERMISSION_CLASSES': (
        # 'rest_framework.permissions.IsAuthenticatedOrReadOnly',
        'rest_framework.permissions.IsAuthenticated',  # Тільки з токеном!
    ),
